...
$config = [
     ...
     * LC_CTYPE=C tr -c -d '0123456789abcdefghijklmnopqrstuvwxyz' </dev/urandom | dd bs=32 count=1 2>/dev/null;
     */
    'secretsalt' => 'Doctrine9-Impound-Caucasian-Substance-Limb',
     ...
     * syntaxes.
     */
    'store.sql.dsn'                 => 'sqlite:/var/simplesamlphp/data/db/sqlitedatabase.sq3',
